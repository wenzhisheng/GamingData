 ...
 * @ClassName: com.quanmin.djdata.lol.dao.ILolTeamBluePicksDao
 */
@Repository
public interface ILolTeamBluePicksDao {

    /**
     * @author: ate
     * @description: 保存英雄联盟赛果战队蓝队选择英雄
